...
class SparseEStepLCNusc(dict):
    def __init__(self, root, voxel_size, version, verbose, **kwargs):
        ...
        super(SparseEStepLCNusc, self).__init__({
            "train": _SparseEStepLCNusc(nusc=self.nusc, voxel_size=voxel_size, split="train"),
            "val": _SparseEStepLCNusc(nusc=self.nusc, voxel_size=voxel_size, split="val")
        })


class _SparseEStepLCNusc(data.Dataset):
    labels_mapping = {
        1: 0,
        5: 0,
        7: 0,
    ...
    def __init__(self, nusc, voxel_size, split="train"):
        self.nusc = nusc
