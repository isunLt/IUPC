...
class NuScenesAssoP2PLCPLSparseLabel(dict):
    def __init__(self, root, voxel_size, version, verbose, **kwargs):
        ...
        super(NuScenesAssoP2PLCPLSparseLabel, self).__init__({
            "train": _NuScenesInternalAssoP2PLCPLSparseLabel(nusc=self.nusc, voxel_size=voxel_size, split="train",
                                                             image_crop_rate=im_cr, superpixel=superpixel,
                                                             pseudo_label_dir=pseudo_label_dir,
                                                             use_augment=use_augment),
            "val": _NuScenesInternalAssoP2PLCPLSparseLabel(nusc=self.nusc, voxel_size=voxel_size, split="val",
                                                           image_crop_rate=im_cr, superpixel=superpixel,
                                                           use_augment=False)
        })


class _NuScenesInternalAssoP2PLCPLSparseLabel(data.Dataset):
    labels_mapping = {
        1: 0,
        5: 0,
        7: 0,
    ...
    def __init__(self, nusc, voxel_size, split="train", **kwargs):
        ...
        self.superpixel_dir = configs['dataset']['superpixel']
